...
#include "sculk/protocol/codec/command/CommandEnumData.hpp"
#include "sculk/protocol/codec/command/CommandPermissionLevel.hpp"
...
SCULK_PROTOCOL_PACKET_FORMATTER(AvailableCommandsPacket)